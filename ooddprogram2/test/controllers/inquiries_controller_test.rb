...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { house_id: @inquiry.house_id, hunter_id: @inquiry.hunter_id, message: @inquiry.message, response: @inquiry.response, subject: @inquiry.subject } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { house_id: @inquiry.house_id, hunter_id: @inquiry.hunter_id, message: @inquiry.message, response: @inquiry.response, subject: @inquiry.subject } }
